...
do18 l@[r0,r1,r2,r3,r4,r5] =  unsafePerformIO $ print l >> return
  (let five = max r5 (((r4) `div` 256) ) in [r0,1, 26,r3, 0,five ])

runlst :: [Instr] -> Regs -> Regs
runlst ins rs = if rs!!ipr==18 then runlst ins (do18 rs) else
